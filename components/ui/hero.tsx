...
const Hero = () => {
	return (
		<header className='font-[family-name:var(--font-geist-sans)] h-screen w-full rounded-md bg-transparent relative flex flex-col items-center justify-center antialiased'>
